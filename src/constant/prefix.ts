 ...
 */
const PUBLIC_KEY_MULTIBASE = "ed01"
 ...
 * @see https://www.w3.org/TR/cid/#Multikey
 */
const PRIVATE_KEY_MULTIBASE = "8026"
 ...
 * - `0603_2b6570`: `Object Identifier` (3 bytes, with content of 1.3.101.112, representing Ed25519);
 * - `0321`: `BIT STRING` (33 bytes following, a byte for version and 32 bytes for public key);
 * - `00`: Version 0.
 */
const PUBLIC_KEY_UNCOMPRESSED = "302a300506032b6570032100"
